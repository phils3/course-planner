...
function Fejléc({órák_háttér_színe,betű_szín,padding,width}) {
    const { fejlecWidth, oszlopSzelesseg } = useContext(Beallitasok);
    const gradientBackground = "linear-gradient(to bottom, #2EA98C   ,rgb(48, 47, 47) 100% )";
    let fontSize = "clamp(1rem, 2vw, 1.7em)";
    let orakOszlopSzelesseg = `${oszlopSzelesseg}vw`;
    let napOszlopSzelesseg = `${oszlopSzelesseg}vw`;
    return ( 
        <div style={{display:"flex",width:`${fejlecWidth}vw`}}>
